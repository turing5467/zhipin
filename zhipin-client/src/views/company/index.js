...
import {requestCPNList} from '../../common/request'
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            filter: [{
                ...
                "title": "行业类型: ",
                "en": "industry",
                "options": ["不限", "电子商务", "游戏", "媒体", "广告营销", "数据服务", "医疗健康", "生活服务", "O2O", "旅游", "分类信息", "音乐/视频/阅读", "在线教育", "社交网络", "人力资源服务", "企业服务", "信息安全", "智能硬件", "移动互联网", "互联网", "计算机软件", "通信/网络设备", "广告/公关/会展", "互联网金融", "物流/仓储", "贸易/进出口", "咨询", "工程施工", "汽车生产", "其他行业"]
            }, {
                "title": "融资阶段: ",
                "en": "stage",
        ...
        return (
            <div className="filter-box">
                <div class="filter-condition ">
                    {filter.map((ele,index) => <div key={ele.en} class={"filter-row "+ele.en}>
            ...
            <div className="page">
                <Pagination defaultCurrent={1} total={total} pageSize={28} onChange={this.handlePage}/>
            </div>
            </div>
        )
    }
